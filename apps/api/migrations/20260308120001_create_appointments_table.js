...
exports.up = function (knex) {
  return knex.schema.createTable(Tables.APPOINTMENTS, (table) => {
    ...
    // Client info – either a registered user or a walk-in / booking via WhatsApp
    table.integer("user_id").nullable().references("id").inTable(Tables.USERS).onDelete("SET NULL");
